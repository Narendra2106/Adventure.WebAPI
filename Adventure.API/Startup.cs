using Adventure.API.Extensions;
...
namespace Adventure.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCustomScoped(); // Extension method for custome Scoped

            services.AddPlayerAdventureContext(Configuration); //// Extension method for Adventure Context
        }
